...
module.exports = (function (arg) {
  ...
  var defaults = {
    ...
    // path etc. Set to 0 in .configure
    ...
    // When not false assumes 1 argument is primary command.
   ...
   * @param  {Boolean} [wrapQuotes] when NOT false strings are wraped w/ quotes.
   * @return {Object}
   */
  Pargv.prototype.flagsToArray = function flagsToArray(defaults, wrapQuotes) {
      ...
      keys.forEach(function(k) {
        ...
        // If flag === true push flag only.
        if(flag !== true){

          if(typeof flag === 'string' && wrapQuotes !== false){
