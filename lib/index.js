...
module.exports = (function (arg) {
   ...
   * "-" or "--" in your defaults object.
   * @example
   * pargv.flagsToArray();
   * @param  {Object} [defaults] object containing defaults for matched flags.
   * @param  {Object} [obj] when passed this object is used to parse for flags.
   * @return {Object}
   */
  Pargv.prototype.flagsToArray = function flagsToArray(defaults, obj) {
